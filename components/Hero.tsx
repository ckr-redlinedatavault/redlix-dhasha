...
export default function HeroWithCards() {
    ...
    return (
        <section className={`${bricolage.className} relative z-0 min-h-screen bg-black overflow-hidden flex flex-col items-center pt-52 pb-20`}>
            ...
            <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                ...
                {/* CARDS SECTION */}
                <div className="flex flex-row items-center justify-center gap-4 md:gap-8 lg:gap-12 mt-20 md:mt-24 w-full min-h-[400px] md:min-h-[600px] lg:min-h-[700px]">
