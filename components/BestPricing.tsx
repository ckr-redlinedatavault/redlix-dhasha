...
export default function Pricing() {
    ...
    return (
        <section className={`${bricolage.className} py-24 bg-black text-white relative overflow-hidden`}>
            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className={`relative p-8 rounded-[2.5rem] border transition-all duration-500 hover:scale-[1.02] flex flex-col ${plan.isPopular
