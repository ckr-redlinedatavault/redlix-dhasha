...
export default function WhyChooseUs() {
    ...
    return (
        <section className={`${bricolage.className} py-20 bg-black overflow-hidden`}>
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-16 gap-x-12">
                    {features.map((feature, index) => (
                        <div
                            key={index}
                            className="relative h-56 flex items-center group"
                        >
                            ...
                            <div className="relative z-10 w-full h-full flex items-center">
                                ...
                                {/* IMAGE CONTAINER */}
                                <div className="w-[45%] h-full relative flex justify-center items-end pointer-events-none">
                                    <img
                                        src={feature.image}
                                        alt={feature.title}
                                        className="absolute bottom-0 h-[100%] w-auto max-w-none object-contain grayscale brightness-110 drop-shadow-[0_20px_40px_rgba(0,0,0,0.35)]"
                                        style={{
                                ...
                                {/* TEXT CONTENT */}
                                <div className="w-[55%] pr-8 pl-0 py-4 flex flex-col justify-center">
