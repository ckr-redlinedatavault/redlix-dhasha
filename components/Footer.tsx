...
export default function Footer() {
    ...
    return (
        <footer className={`${bricolage.className} bg-gradient-to-r from-[#B89E6C] via-[#DAC291] to-[#EAD7B0] pt-16 pb-12 text-black`}>
            ...
            <div className="absolute bottom-0 left-0 w-full overflow-hidden pointer-events-none opacity-5">
                <span className="text-[15vw] leading-none font-black text-black whitespace-nowrap block text-center transform translate-y-1/4 select-none">
                    DHASHA MEDIA
                </span>
            </div>
        </footer>
