                ...
                <div className="max-w-5xl mx-auto relative z-10">
                    ...
                    <div className="space-y-16 text-gray-300 font-light leading-relaxed text-base md:text-lg">
                        ...
                        <section>
                            ...
                            <p>
                                Dhasha Media is an integrated freelance media consultancy offering 10-in-1 creative solutions including digital marketing, branding, content creation, and media consulting. We operate as an independent freelance collective, not as a government-registered corporate entity.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <p className="mb-4">Our data protection practices are designed to align with applicable Indian laws, including:</p>
                            <ul className="list-disc pl-6 space-y-2 marker:text-[#DAC291]">
                                <li>Information Technology Act, 2000 (and applicable rules)</li>
                        ...
                        <section>
                            ...
                            <p>
                                As a freelance consultancy, the information collected by Dhasha Media is stored and processed using secure third-party cloud infrastructure (e.g., Google Workspace, AWS, or similar providers) which may be located within India or globally. We utilize industry-standard freelance toolkits to ensure your data is handled with professional care and hygiene.
                            </p>
                        </section>
